...
The dataset is on an annual level for 2005 to 2014. The variables for each metro area include; the population size, employment broken down by sector, the unemployment rate, and GMP. The employment values for each subcategory are provided in thousands of jobs for that category of employment for the year. Descriptions of each variable are provided below:
...
Employment - 42 - Wholesale Trade	Thousands of Persons	Measures the number of employees (in thousands) working in wholesale trade industry sector as defined by the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment- 44-45 - Retail Trade	Thousands of Persons	Measures the number of employees (in thousands) working in retail trade industry sector as defined by the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment - 48-49 - Transportation and Warehousing	Thousands of Persons	Measures the number of employees (in thousands) working in the broader logistics (transportation and warehousing) sector as defined by the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment - 51 - Information	Thousands of Persons	Measures the number of employees (in thousands) working in the information sector as defined by the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment - 52 - Finance and Insurance	Thousands of Persons	Measures the number of employees (in thousands) working in the financial services and insurance sector  as defined by the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment - 53 - Real Estate and Rental and Leasing	Thousands of Persons	Measures the number of employees (in thousands) working in the broader real estate/ property management sector as defined by the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment - 54 - Professional, Scientific, and Technical Services	Thousands of Persons	Measures the number of employees (in thousands) working in the professional/scientific/technical services sectors as defined by the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment - 55 - Management of Companies and Enterprises	Thousands of Persons	Measures the number of employees (in thousands) working in the management of companies as defined by the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment - 61 - Educational Services	Thousands of Persons	Measures the number of employees (in thousands) working in education as defined by the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment - 62 - Health Care and Social Assistance	Thousands of Persons	Measures the number of employees (in thousands) working in health care and social assistance as defined by the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment - 71 - Arts, Entertainment, and Recreation	Thousands of Persons	Measures the number of employees (in thousands) working in arts, entertainment, and recreation as defined by the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment - 72 - Accommodation and Food Services	Thousands of Persons	Measures the number of employees (in thousands) working in the accomodation/food services industry per the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Employment - 81 - Other Services (except Public Administration)	Thousands of Persons	Measures the number of employees (in thousands) working in other private sector fields that can't be easily put into any other category per the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED. 
Employment - 92 - Public Administration	Thousands of Persons	Measures the number of employees (in thousands) working for state, local, or federal government per the North American Industrial Classification System (NAICS). Raw data source: U.S. Bureau of Labor Statistics (BLS) State and Area Employment, Hours, and Earnings dataset via FRED.
Total Employment	Thousands of Persons	The total number of people currently employed across all industry sectors in the specified geographic area (National or MSA). Raw data source: U.S. Bureau of Labor Statistics (BLS) Local Area Unemployment Statistics (LAUS) program via FRED.
Unemployment Rate	Percent (Not Seasonally Adjusted)	The percentage of the total labor force that is currently unemployed, available to work, and actively seeking employment. Raw data source: U.S. Bureau of Labor Statistics (BLS) Local Area Unemployment Statistics (LAUS) program via FRED.
Gross Metro Product (GMP)	Millions of Chained 2017 Dollars (Not Seasonally Adjusted)	The total value of all finished goods and services produced within a specific Metropolitan Statistical Area. Raw data source: U.S. Bureau of Economic Analysis (BEA) regional economic accounts via FRED.
US GDP (GDPC1)	Billions of Chained 2017 Dollars (Seasonally Adjusted)	Real Gross Domestic Product for the entire United States. Raw data source: U.S. Bureau of Economic Analysis (BEA) via FRED 
Population	Thousands of Persons	The total resident population of the specified geographic area. Raw data source: U.S. Census Bureau annual population estimates via FRED.
<img width="1291" height="1921" alt="image" src="https://github.com/user-attachments/assets/2ea87d48-d792-4022-96c6-724c57711dd4" />
